...
<footer className="footer footer-center p-10 bg-purple-600 text-base-content rounded">
  <nav className="grid grid-flow-col gap-4 text-xl">
    ...
    <br />
    <Link to='/appliedJobs'><a className="link link-hover">Applied Jobs</a></Link>
    <br />
    <Link to='/addaJobs'><a className="link link-hover">Add a Jobs</a></Link>
    <br />
  ...
  <aside>
    <p className="font-bold">Copyright © 2023 - All right reserved by FIND JOB</p>
  </aside>
</footer>
